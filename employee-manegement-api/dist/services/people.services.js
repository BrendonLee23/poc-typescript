...
var people_repository_1 = __importDefault(require("@/repositories/people.repository"));
function getEmployees() {
    return __awaiter(this, void 0, void 0, function () {
        var employees;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, people_repository_1.default.getEmployees()];
                case 1:
                    employees = _a.sent();
...
/* async function postEmployees(firstName, lastName, age){
